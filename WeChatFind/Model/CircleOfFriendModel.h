...
@class CircleOfFriendLikeItemModel, CircleOfFriendCommentItemModel;

//朋友圈数据Model
@interface CircleOfFriendModel : NSObject
...
@property(nonatomic,strong)NSMutableArray<CircleOfFriendLikeItemModel *> * likeArr;//存放Model点赞数组
@property(nonatomic,strong)NSMutableArray<CircleOfFriendCommentItemModel *> * commentArr;//存放Model评论数组
...
//点赞Model
@interface CircleOfFriendLikeItemModel : NSObject
...
//评论Model
@interface CircleOfFriendCommentItemModel : NSObject
@property(nonatomic,copy)NSString * optid;;
